...
const modules = [
  ...
  { name: "AI Intake", body: "A lead answers your firm's screening questions, uploads documents, and arrives conflict-checked — staff review every file before anything is accepted.", status: "Planned" },
    { name: "Practice Management Sync", body: "Matters, contacts, and deadlines read from Clio or MyCase into the Morning Brief — read-only, like everything else.", status: "Planned" },
